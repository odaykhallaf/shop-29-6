...
public class AdminTools {
    ...
    public AdminTools(UserService userService, VendorService vendorService, OrdersService ordersService, ProductService productService, CategoryService categoryService) {
