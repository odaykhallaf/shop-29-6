...
public class ProductController {
    ...
    public ProductController(ProductService productService, CategoryService categoryService, AdminTools adminTools) {
    ...
    public String viewCategoryByPage(@PathVariable("category_alias") String alias,
        ...
        try {
            ...
            listProducts.forEach(product -> product.setFormattedPrice(productService.formatPrice(product.getPrice())));
    ...
    public String viewProductDetails(@PathVariable("product_alias") String alias, Model model) {
        try {
            ...
            product.setFormattedPrice(productService.formatPrice(product.getPrice()));
    ...
    public String searchByPage(@Param("keyword") String keyword,
        ...
        resultList.forEach(product -> product.setFormattedPrice(productService.formatPrice(product.getPrice())));
